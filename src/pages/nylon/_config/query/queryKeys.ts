export const nylonQK = {
	...
	nylonMFProductionLogByUUID: (uuid: string) => [
	...
	nylonMetallicFinishingRMByUUID: (uuid: string) => [
	...
	nylonMetallicFinishingRMLogByUUID: (uuid: string) => [
	...
	orderAgainstNylonFinishingRMLogByUUID: (uuid: string) => [
	...
	nylonMetallicTapeLogByUUID: (uuid: string) => [
		...nylonQK.nylonMetallicTapeLog(),
		uuid,
	],
	...
	nylonPlasticFinishingTapeLogByUUID: (uuid: string) => [
	...
	nylonPlasticFinishingProductionLogByUUID: (uuid: string) => [
		...nylonQK.all(),
		'tm-production-log',
		uuid,
	],
	...
	nylonPlasticFinishingTrxLogByUUID: (uuid: string) => [
