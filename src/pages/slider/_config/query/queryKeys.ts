export const sliderQK = {
	...
	sliderAssemblyRMByUUID: (uuid: string) => [
		...sliderQK.sliderAssemblyRM(),
		uuid,
	],

	// * RM Log
	sliderAssemblyRMLog: () => [...sliderQK.all(), 'assembly-rm-log'],
	sliderAssemblyRMLogByUUID: (uuid: string) => [
	...
	sliderDashboardInfoByUUID: (uuid: string) => [
	...
	sliderDieCastingStockByUUID: (uuid: string) => [
		...sliderQK.sliderDieCastingStock(),
		uuid,
	],
	sliderDieCastingStockByOrderNumbers: (numbers: string[]) => [
		...sliderQK.sliderDieCastingStock(),
		...numbers,
	],
	...
	sliderDieCastingTransferByUUID: (uuid: string) => [
		...sliderQK.sliderDieCastingStock(),
		uuid,
	],
	...
	sliderDieCastingByStockByUUID: (uuid: string) => [
	...
	sliderDieCastingByOrderByUUID: (uuid: string) => [
	...
	sliderDieCastingProductionByUUID: (uuid: string) => [
	...
	orderAgainstSliderAssemblyRMLogByUUID: (uuid: string) => [
	...
	sliderDieCastingRMByUUID: (uuid: string) => [
	...
	sliderDieCastingRMLogByUUID: (uuid: string) => [
	...
	orderAgainstDieCastingRMLogByUUID: (uuid: string) => [
	...
	sliderColoringRMByUUID: (uuid: string) => [
		...sliderQK.sliderColoringRM(),
		uuid,
	],

	// * RM Log
	sliderColoringRMLog: () => [...sliderQK.all(), 'c-rm-log'],
	sliderColoringRMLogByUUID: (uuid: string) => [
	...
	orderAgainstSliderColorRMLogByUUID: (uuid: string) => [
	...
	sliderAssemblyStockByUUID: (uuid: string) => [
	...
	sliderAssemblyProductionByUUID: (uuid: string) => [
	...
	sliderAssemblyProductionEntryByUUID: (uuid: string) => [
	...
	sliderAssemblyTransferEntryByUUID: (uuid: string) => [
	...
	sliderAssemblyLogProductionByUUID: (uuid: string) => [
	...
	sliderAssemblyLogTransactionByUUID: (uuid: string) => [
	...
	sliderAssemblyStockTransactionByUUID: (uuid: string) => [
	...
	sliderAssemblyStockProductionByUUID: (uuid: string) => [
	...
	sliderColoringProductionByUUID: (uuid: string) => [
