export const deliveryQk = {
	...
	deliveryPackingListByUUID: (uuid: string) => [
		...deliveryQk.deliveryPackingList(),
		uuid,
	],
	deliveryPackingListDetailsByUUID: (uuid: string) => [
		...deliveryQk.all(),
		'packing-list',
		'details',
		uuid,
	...
	deliveryPackingListEntryByPackingListUUIDS: (
		packing_list_uuids: string[]
	) => [...deliveryQk.all(), 'packing-list', 'entry', ...packing_list_uuids],

	deliveryChallanEntryForPackingListByPackingListUUIDS: (
		packing_list_uuids: string[]
	...
	deliveryPackingListEntryByUUID: (uuid: string) => [
	...
	deliveryRMLogByUUID: (uuid: string) => [
		...deliveryQk.deliveryRMLog(),
		uuid,
	],
	...
	orderAgainstDeliveryRMLogByUUID: (uuid: string) => [
...
export const challanQK = {
	...
	deliveryChallanByUUID: (uuid: string) => [
		...challanQK.deliveryChallan(),
		uuid,
	],
	deliveryChallanDetailsByUUID: (uuid: string) => [
		...challanQK.all(),
		'delivery-challan',
		'details',
		uuid,
	...
	deliveryChallanEntryByUUID: (uuid: string) => [
