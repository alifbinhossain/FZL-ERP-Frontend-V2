	...
	return (
		<div className='flex min-h-screen min-w-max flex-col justify-center bg-background py-6 sm:py-12'>
			<div className='relative min-w-[40%] py-3 sm:mx-auto sm:max-w-xl'>
				<div className='absolute inset-0 -skew-y-6 transform animate-pulse bg-linear-to-r from-primary to-primary/50 shadow-lg sm:-rotate-6 sm:skew-y-0 sm:rounded-3xl'></div>
